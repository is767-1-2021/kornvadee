...
void main() async {
  ...
  var services = NotisServices();
  var controller = NotisController(services);

  runApp(NotisApp(controller: controller));
}
// void main() {
...
class NotisApp extends StatelessWidget {
  final NotisController controller;
  NotisApp({required this.controller});

  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Listviewtest(controller: controller),
    );
  }
}
